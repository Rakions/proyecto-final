...
CREATE TABLE CARTS_DETAILS(
  CART_DETAILS_ID NUMBER NOT NULL PRIMARY KEY,
  CART_ID NUMBER,
  PRODUCTS_ID NUMBER,
  QUANTITY NUMBER
);
...
ALTER TABLE CARTS ADD CONSTRAINT FK_CARTS_USERID FOREIGN KEY (USER_ID) REFERENCES CAFE_USERS(USER_ID);

ALTER TABLE CARTS_DETAILS ADD CONSTRAINT FK_CARTS_DETAILS_CARTID FOREIGN KEY (CART_ID) REFERENCES CARTS(CART_ID);

ALTER TABLE CARTS_DETAILS ADD CONSTRAINT FK_CARTS_DETAILS_USERID FOREIGN KEY (PRODUCTS_ID) REFERENCES PRODUCTS(PRODUCTS_ID);
