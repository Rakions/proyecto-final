...
function renderCafes(index,categoria){
  if (producto[index]["category_id"] == categoria) {
    carta_content.innerHTML += `<a href="#" onclick="agregarCarrito(${producto[index]["products_id"]})" <div class="h-[300px] w-[300px] flex items-center justify-center flex-col rounded-xl text-[var(--color-oscuro)]">
